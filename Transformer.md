...
* **总体模型**
  ...
  **模型主要分为Encoder和Decoder层**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Model%20total%20one.png)
  ...
  **思考**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Model%20total%20two.png)
...
* **Positional embedding**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Position%20embedding%20one.jpeg)
  ...
  **3** | .. | .. | .. | .. | ..
  ...
  将其分别进行sin cos计算
   ...
   ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Position%20embedding%20two.jpeg)
   
   位置p+k的向量可以表示成位置p的向量的线性变换，这提供了表达相对位置信息的可能性。
   
   ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Position%20embedding%20three.jpeg)
...
　        “The animal didn't cross the street because it was too tired”
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20one.png)
  ...
  **2.如何计算自注意力？**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20three.jpeg)
  
  3.对该得分进行规范、softmax
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20four.jpeg)
  
  4.将带权重的各个value向量加起来产生在这个位置上self-attention层的输出。
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20five.png)
  
  5.整体流程：
   
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20six.png)
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/self%20attention%20seven.png)
...
* **Multi-head Attention**
  ...
  **1.Multi-head Attention是啥？**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/multi-head%20one.png)

  用不同的权重矩阵做8次不同的计算得到8个不同的Z矩阵。
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/multi-head%20two.png)

  把8个矩阵拼接起来然后用一个额外的权重矩阵与之相乘
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/multi-head%20three.png)
  ...
  **2.Multi-head Attention作用**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/multi-head%20six.png)
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/multi-head%20seven.png)
...
* **Decoder**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/decoder%20one.gif)
  
  
  二、每一个时间步，解码器会输出翻译后的一个单词。

  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/decoder%20two.gif)
 ...
 ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/Mask%20one.jpg)
...
　在每个编码器中的每个子层(self-attention, ffnn)在其周围都有一个残差连接，还伴随着一个规范化步骤。
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/resnet%20one.png)
  
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/resnet%20two.png)

  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/resnet%20three.png)
...
* **Position-wise Feed-Forward Networks（FFN）**
  ...
  ![](https://raw.githubusercontent.com/Elliotter/Transformer/master/pic/FFN%20one.png)
